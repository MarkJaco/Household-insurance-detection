...
class Inferer:
    ...
    def infer(self, conf_thres, iou_thres, classes, agnostic_nms, max_det, hide_labels, hide_conf, img_path):
        ...
        pred_results = self.model.forward(img)
        ...
        if len(det):
            ...
            for *xyxy, conf, cls in reversed(det):
                ...
                line = (cls, *xywh, conf)
                detection_li.append([cls, xyxy, conf])
